	...
	while ( have_rows('cta_links') ): the_row();	
		...
		if ( have_rows('cta_link') ):
			...
			if ( $linktype == 'internal' ) {
				echo '<p><a class="button light" href="' . $pagelink . '">' . $linklabel . '</a></p>';
			} elseif ( $linktype == 'external' ) {
				echo '<p><a class="button light" href="' . $exturl . '" target="_blank">' . $linklabel . '</a></p>';
			} elseif ( $linktype == 'pdf' ) {
				echo '<p><a class="pdf_dl light" href="' . $pdf . '" target="_blank">' . $linklabel . '</a></p>';
			}
