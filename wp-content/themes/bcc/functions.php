...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_enqueue_script('modernizr'); // Enqueue it!
         ...
         wp_register_script('modernizr', get_template_directory_uri() . '/assets/js/vendor/modernizr-2.6.2.min.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('modernizr'); // Enqueue it!
    }
}
...
function html5blank_styles()
{
    ...
    wp_register_style('google-font', 'https://fonts.googleapis.com/css?family=Public+Sans:300,400,400i,500,500i,700,700i&display=swap', array(), '1.0', 'all');
...
function footerScripts() {
	...
	wp_register_script('slick-js-cdn', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js',  array('jquery'), null, true);
    wp_enqueue_script('slick-js-cdn'); // Enqueue it!
    
    wp_register_script('fa-js', 'https://use.fontawesome.com/6ccd600e51.js', array('jquery'), null, true);
    wp_enqueue_script('fa-js'); // Enqueue it!
    
    wp_register_script('of-js', get_template_directory_uri() . '/assets/js/vendor/objectFitPolyfill.min.js', array('jquery'), null, true);
    wp_enqueue_script('of-js'); // Enqueue it!
...
add_action('wp_enqueue_scripts', 'footerScripts'); // Add Theme Stylesheet
...
include 'functions/functions_gutenberg.php';
include 'functions/functions_tinymce.php';
