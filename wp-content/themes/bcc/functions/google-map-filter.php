...
function googleMapAPIScript() {
	...
	if (pll_current_language() == 'en-CA') {
		...
		wp_register_script('aa_js_googlemaps_script',  'https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyA7bgPEv6D1DOFBlFH9JSnnsC-2VV4xYrs&language=fr', array('jquery'), null);
		wp_enqueue_script('aa_js_googlemaps_script');
	}
}
