...
add_action( 'wp_enqueue_scripts', function() {
	...
	wp_enqueue_script( 'aa_js_googlemaps_script_fre', 'https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyA7bgPEv6D1DOFBlFH9JSnnsC-2VV4xYrs' . c27()->get_setting( 'general_google_maps_api_key' ) . '&libraries=places&v=3&language=' . $language, [], null, true );
}, 100 );