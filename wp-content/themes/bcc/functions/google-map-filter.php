...
add_action( 'wp_enqueue_scripts', function() {
	...
	wp_enqueue_script( 'c27-google-maps', 'https://maps.googleapis.com/maps/api/js?v=3.exp&key=' . c27()->get_setting( 'AIzaSyA7bgPEv6D1DOFBlFH9JSnnsC-2VV4xYrs' ) . '&libraries=places&v=3&language=' . $language, [], null, true );
}, 100 );